        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-300 max-w-4xl mx-auto leading-relaxed">
              ...
              delivered 150+ projects for startups and enterprises worldwide, helping them secure over $15M in funding 
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="text-center p-6 bg-neutral-900/50 rounded-xl border border-neutral-800">
              <h3 className="text-xl font-bold text-white mb-3">$15M+ Funding Secured</h3>
